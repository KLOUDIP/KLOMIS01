...
class PaymentProvider(models.Model):
    ...
    code = fields.Selection(
        selection_add=[('sampath_int', "Sampath_int Bank International")], ondelete={'sampath_int': 'set default'})
    sampath_int_client_id = fields.Char(
        string="Sampath ClientID", required_if_provider='sampath_int', groups='base.group_system')
    sampath_int_hmac_secret = fields.Char(string="Sampath HMAC Secret", groups='base.group_system')
    sampath_int_auth_token = fields.Char(
        string="Auth Token", help="Auth token for confirm the transaction", required_if_provider='sampath_int')

    def _sampath_int_get_api_url(self):
        """ sampath URLS """
