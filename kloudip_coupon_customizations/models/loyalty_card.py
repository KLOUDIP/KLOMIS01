...
class LoyaltyCard(models.Model):
    ...
    @api.depends('code', 'program_id.name')
    def _compute_display_name(self):
        """Override display name compute to show coupon program name"""
        for coupon in self:
            coupon.display_name = coupon.code + ' - ' + coupon.program_id.name
